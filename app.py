...
def main():
    ...
    if page=="Dashboard":
        st.info("Dashboard loading not implemented yet")
    elif page=="Service Entry":
        service_entry_page()
    elif page=="Expenses Entry":
        st.info("Expenses Entry loading not implemented yet")
    elif page=="Transactions Entry":
        st.info("Transactions Entry loading not implemented yet")
    elif page=="Suppliers Entry":
        st.info("Suppliers Entry loading not implemented yet")
